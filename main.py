...
import input_data
mnist = input_data.read_data_sets('~/DS_ML/Deep Learning/',
                                  one_hot=True)
...
# creating the tensor flow graph inputs
...
with tf.Session() as sess:
    ...
    summary_writer = tf.summary.FileWriter('~/DS_ML/Deep Learning/',
    ...
    for iteration in range(training_iteration):
        ...
        for i in range(total_batch):
            ...
            summary_writer.add_summary(
                summary_str, iteration * total_batch + i)
